...
@section('content')
    <form action="{{ route('product.update', $edit->id) }}" method="post">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-3">
                <input value="{{ $edit->product_qty }}" required type="number" class="form-control" name="product_qty" placeholder="Qty">
            </div>
        </div>
        <div class="mb-3 row">
            <div class="col-sm-2">
            ...
            <div class="col-sm-3">
                <input value="{{ $edit->product_price }}" required type="number" class="form-control" name="product_price" placeholder="Harga">
            </div>
            <div class="mb-3 row">
                <div class="col-sm-10">
